...
| File | Description |
|---|---|
| `data_digger.sql` | Original SQL script (schema + data + queries) |
| `run_digger.py` | Executes every statement against SQLite and captures real outputs |
| `build_readme.py` | Renders the captured outputs into this README |
